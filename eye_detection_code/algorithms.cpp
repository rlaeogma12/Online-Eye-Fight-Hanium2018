...
void InitCascades() {
	string path;
	path = "C:/opencv/sources/data/haarcascades/new/haarcascade_frontalface_alt_tree.xml";
	face_cascade = (CvHaarClassifierCascade *)cvLoad(path.c_str(), 0, 0, 0);
	path = "C:/opencv/sources/data/haarcascades/new/haarcascade_mcs_lefteye.xml";
	left_eye_cascade = (CvHaarClassifierCascade *)cvLoad(path.c_str(), 0, 0, 0);
	path = "C:/opencv/sources/data/haarcascades/new/haarcascade_mcs_righteye.xml";
